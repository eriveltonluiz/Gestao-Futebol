...
@Entity
public class VermelhosPartidaMand implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VermelhosPartidaMand other = (VermelhosPartidaMand) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public void incluirVermelhoAoJogadorTimeMandante(Jogador jogador, Confrontos confronto) {
		this.jogador = jogador;
